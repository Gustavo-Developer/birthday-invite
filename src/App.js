...
function App() {
  let audio = new Audio("./parabens-audio.mp3");
  ...
  return (
    <>
      ...
      <div className={isActive ? "d-flex" : "d-none"}>
        <div className="App">
          <div className="gradient-border content" id="box">
            ...
            >
              ...
              <p
                style={{ color: "#C0392B", margin: "10px", fontWeight: "bold" }}
              >
                21 ANOS
              </p>
            </div>
            ...
            <p style={{ fontSize: "22px", textAlign: "center" }}>
              Bebibas deveram ser adquiridas no Local
            </p>
            <p style={{ fontSize: "22px", textAlign: "center" }}>
              Contamos com você ❤️{" "}
            </p>
